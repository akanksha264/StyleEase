...
export default function Product() {
  ...
  const handleFilter = (option, sectionId) => {
    const searchParams = new URLSearchParams(location.search);

    let value = option.value;
    let state = option.checked;
  ...
  useEffect(() => {
    ...
    const data={
      topCategory:param.levelOne,
      secondCategory:param.levelTwo,
      thirdCategory:param.levelThree,
      color:colorValue || [],
      size:sizeValue || [],
      minPrice:minPrice || "",
      maxPrice:maxPrice || "",
    ...
    <div className="bg-white">
      <div>
        ...
        <main className="mx-auto px-4 sm:px-6 lg:px-20">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
              ...
              <div>
                <form className="hidden lg:block">
                  <div className="py-10 flex justify-between items-center opacity-50">
          ...
          <section>
            <div><Pagination count={products?.products?.totalPages} color="secondary" shape="rounded" onChange={handlePageChange}/></div>
          </section>
        </main>
      </div>
    </div>
